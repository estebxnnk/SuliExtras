...
const StateChangeSuccessSpinner = ({ 
  open, 
  message = 'Estado del registro cambiado exitosamente', 
  showLogo = true,
  onComplete 
}) => {
  React.useEffect(() => {
      ...
      >
        <Box
          sx={{
            ...
            gap: 3,
            p: 4,
            background: 'linear-gradient(135deg, rgba(255,255,255,0.98) 0%, rgba(255,248,255,0.98) 100%)',
            borderRadius: 4,
        ...
        >
          ...
          {/* Icono de cambio de estado exitoso con animación */}
          <Box
            sx={{
              position: 'relative',
              display: 'flex',
...
export default StateChangeSuccessSpinner;
