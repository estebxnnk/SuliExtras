...
function DashboardAdmin() {
  ...
  const usuariosPorRol = useMemo(() => {
    ...
    return Object.entries(conteo).map(([rol, cantidad], i) => ({ id: i, value: cantidad, label: rol }));
  }, [usuarios]);
      ...
      <Box sx={{ flex: 1, width: '100%', maxWidth: 1400, mx: 'auto', mt: 16, mb: 6, px: 2 }}>
        ...
        <Grid container spacing={3} alignItems="flex-end">
          ...
          <Grid item xs={12} md={4}>
            <Card sx={{ borderRadius: 4, boxShadow: '0 2px 16px #fbc02d', p: 2, background: 'linear-gradient(90deg,#fffde7 60%,#fff9c4 100%)', display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          {/* Usuarios por rol */}
          <Grid item xs={12} md={4}>
            <Card sx={{ borderRadius: 4, boxShadow: '0 2px 16px #b6d0f7', p: 2 }}>
              <CardContent>
          ...
          {/* Total horas extra */}
          <Grid item xs={12} md={4}>
            <Card sx={{ borderRadius: 4, boxShadow: '0 2px 16px #b6d0f7', p: 2, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: 200 }}>
