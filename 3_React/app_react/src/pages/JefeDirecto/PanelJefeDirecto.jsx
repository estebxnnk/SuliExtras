...
function PanelJefeDirecto() {
  ...
  // Modal detalles registro (opcional, para futuro)
            ...
            <Table size="small" sx={{ mb: 2 }}>
              ...
              <TableBody>
                {registrosRecientes.length === 0 && (
                  <TableRow>
                    <TableCell colSpan={4} align="center">No hay registros en el rango.</TableCell>
                  </TableRow>
                )}
